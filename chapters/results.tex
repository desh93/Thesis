...
\section{Model independent exclusion limits}\label{sec:results:modelindep}
...
\begin{figure}[!htpb]
    ...
    \centering
    \includegraphics[width=0.7\textwidth]{/Users/Deshan/Documents/PhD/thesis/Thesis/figures/results/fig_03a.pdf}
    \label{fig:limit_n1}
...
\subsubsection{Ingredients for reinterpretation}\label{sec:results:reinterp}
...
\subsubsection{Evolution of analysis sensitivity}\label{sec:results:evol}
